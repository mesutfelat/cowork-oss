...
const quickActions = [
  { icon: 'file', label: 'Create a file' },
  { icon: 'data', label: 'Crunch data' },
  { icon: 'prototype', label: 'Make a prototype' },
  { icon: 'organize', label: 'Organize files' },
  { icon: 'meeting', label: 'Prep for a meeting' },
  { icon: 'message', label: 'Draft a message' },
];
